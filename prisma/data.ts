...
export const dailyChallengeData: {
    ...
    // Difficulté 1
    {
        ...
        description: "Débranchez tous les appareils électroniques en veille pour économiser de l'énergie.",
        difficulty: 1,
        points: 50,
    },
    {
        ...
        description: "Évitez les bouteilles en plastique en utilisant une gourde réutilisable toute la journée.",
        difficulty: 1,
        points: 50,
    },
    {
        ...
        description: "Évitez d'imprimer des documents et préférez les formats numériques.",
        difficulty: 1,
        points: 50,
    },
    {
        id: 4,
        name: "Tri Sélectif",
        description: "Effectuez un tri sélectif rigoureux de vos déchets ménagers aujourd'hui.",
        difficulty: 1,
        points: 50,
    },
    // Difficulté 2
    ...
    },
    {
        ...
        description: "Préparez et consommez uniquement des repas végétariens aujourd'hui.",
        difficulty: 2,
        points: 100,
    },
    {
        id: 7,
        name: "Marche ou Vélo",
        description: "Effectuez vos déplacements courts à pied ou à vélo plutôt qu'en voiture.",
        difficulty: 2,
        points: 100,
    },
    {
    ...
    // Difficulté 3
    {
        ...
        description: "Consacrez 30 minutes à ramasser les déchets dans votre quartier ou un parc local.",
        difficulty: 3,
        points: 150,
    },
    {
        ...
        description: "Plantez une fleur, une plante aromatique ou un arbre dans votre jardin ou sur votre balcon.",
        difficulty: 3,
        points: 150,
    },
    {
        ...
        description: "Préparez un repas en utilisant des ingrédients sans emballage plastique.",
        difficulty: 3,
        points: 150,
    },
    {
    ...
    },
    {
        ...
        description: "Participez à une action écologique locale, comme un nettoyage de plage ou de forêt.",
        difficulty: 4,
        points: 200,
    },
    {
        ...
        description: "Évitez tous les produits en plastique à usage unique pendant la journée.",
        difficulty: 4,
        points: 200,
    },
    {
    ...
    },
    {
        ...
        description: "Consommez uniquement des aliments locaux et de saison tout au long de la journée.",
        difficulty: 5,
        points: 250,
    },
    {
        ...
        description: "Organisez une campagne de sensibilisation écologique en ligne ou en personne.",
        difficulty: 5,
        points: 250,
    },
    {
...
export const weeklyChallengeData: {
    ...
    // Difficulté 1
    {
        ...
        description: "Lisez un article ou regardez un documentaire sur l'écologie pendant la semaine.",
        difficulty: 1,
        points: 150,
    },
    {
    ...
    },
    {
        ...
        description: "Utilisez un sac réutilisable pour toutes vos courses de la semaine.",
        difficulty: 1,
        points: 150,
    },
    {
        ...
        description: "Assurez-vous d'éteindre les lumières inutilisées tout au long de la semaine.",
        difficulty: 1,
        points: 150,
    },
    // Difficulté 2
    {
        ...
        description: "Consommez des repas végétariens pendant au moins deux jours cette semaine.",
        difficulty: 2,
        points: 300,
    },
    {
    ...
    },
    {
        ...
        description: "Recyclez correctement tous vos déchets recyclables pendant la semaine.",
        difficulty: 2,
        points: 300,
    },
    {
        ...
        description: "Remplacez vos ampoules par des ampoules basse consommation dans toute la maison.",
        difficulty: 2,
        points: 300,
    },
    // Difficulté 3
    {
        ...
        description: "Réduisez votre consommation d'eau de 20% par rapport à la semaine précédente.",
        difficulty: 3,
        points: 450,
    },
    {
        ...
        description: "N'achetez aucun produit avec emballage plastique pendant toute la semaine.",
        difficulty: 3,
        points: 450,
    },
    {
        id: 11,
        name: "Compostage",
        description: "Commencez à composter vos déchets organiques et faites-le toute la semaine.",
        difficulty: 3,
        points: 450,
    },
    {
        ...
        description: "Remplacez tous vos produits ménagers par des alternatives écologiques.",
        difficulty: 3,
        points: 450,
    },
    // Difficulté 4
    {
        ...
        description: "Utilisez uniquement des modes de transport écologiques (vélo, marche) pendant une semaine.",
        difficulty: 4,
        points: 600,
    },
    {
        ...
        description: "Adoptez une alimentation végétarienne pendant toute la semaine.",
        difficulty: 4,
        points: 600,
    },
    {
        ...
        description: "Réduisez votre consommation d'énergie électrique de 30% par rapport à la semaine précédente.",
        difficulty: 4,
        points: 600,
    },
    {
        ...
        description: "Organisez une collecte de déchets dans votre quartier ou un espace naturel.",
        difficulty: 4,
        points: 600,
    },
    // Difficulté 5
    ...
    },
    {
        ...
        description: "Entreprenez des travaux pour améliorer l'efficacité énergétique de votre logement.",
        difficulty: 5,
        points: 750,
    },
    {
        ...
        description: "Organisez et animez un atelier ou une conférence sur un sujet écologique.",
        difficulty: 5,
        points: 750,
    },
    {
        ...
        description: "Installez des panneaux solaires ou un système de récupération d'eau de pluie chez vous.",
        difficulty: 5,
        points: 750,
    },
];

export const recommendedChallengeData: {
    date: Date;
    userId: number;
    dailyChallengeId: number;
}[] = [
    // Association de chaque utilisateur avec un défi recommandé pour demain
    {
        date: tomorrow,
        userId: 1,
        dailyChallengeId: 2,
    ...
    },
    {
        date: tomorrow,
        userId: 20,
        dailyChallengeId: 1, // Retour au premier défi si on dépasse 20
    },
];
...
export const articleData: {
    ...
    },
    {
        ...
        image: "/articles/les-effets-du-changement-climatique-sur-la-biodiversite.webp",
    ...
    },
    {
        ...
        image: "/articles/le-role-des-villes-dans-la-lutte-contre-le-changement-climatique.webp",
